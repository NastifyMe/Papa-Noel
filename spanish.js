...
function login() {
    ...
    if (password === 'Papa Noel 2026' && nameLog){
        ...
        document.querySelector('.error').innerText = 'datos incorrectos ❌'
    }
...
function startTyping() {
    ...
    const text = `Querido ${nameLogin}! 🎅\nHe estado observándote todo el año y puedo decir,\n que te has comportado bastante bien.\n Este año te esperan muchas cosas geniales.\n ¡Feliz Año Nuevo, Papá Noel!`;
